...
<?php $component->withAttributes([]); ?>
        <p class="text-xl mb-5">
            <?php echo e(__('app.enter-email-to-continue')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <form action="<?php echo e(route('access')); ?>" method="post" class="w-full" x-data="{ errors: <?php echo e(json_encode($errors->first('email') ?? null)); ?> }">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/mat/Projects/AStA/asta-ticket-refund/resources/views/access.blade.php ENDPATH**/ ?>