...
<?php $component->withAttributes(['step' => 'banking','hide-steps' => true]); ?>
        <div class="">
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.button','data' => ['type' => 'submit','class' => 'w-auto']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'w-auto']); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
        <?php $__currentLoopData = $exports->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $export): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.notification','data' => ['title' => 'Export ' . $export->id . ' (' . count($export->refunds) . ' Anträge)','subtitle' => $export->created_at]] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
