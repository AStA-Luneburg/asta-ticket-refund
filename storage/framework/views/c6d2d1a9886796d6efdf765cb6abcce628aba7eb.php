...
<header <?php echo e($attributes->merge(['class' => 'relative bg-slate-50 border-b-2 border-slate-300 pb-8 md:pt-0 mb-8'])); ?>>
...
<?php $component->withAttributes(['class' => 'relative flex items-stretch flex-col gap-0 md:flex-row md:gap-3 py-2']); ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.header-step','data' => ['href' => '#','index' => '1','active' => ''.e($step === 'welcome' ? true : false).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '#','index' => '1','active' => ''.e($step === 'welcome' ? true : false).'']); ?>
                    <?php echo e(__('app.steps.first')); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.header-step','data' => ['href' => '#','index' => '2','active' => ''.e($step === 'verification' ? true : false).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('header-step'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '#','index' => '2','active' => ''.e($step === 'verification' ? true : false).'']); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.header-step','data' => ['href' => '#','index' => '3','active' => ''.e($step === 'banking' ? true : false).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('header-step'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => '#','index' => '3','active' => ''.e($step === 'banking' ? true : false).'']); ?>
