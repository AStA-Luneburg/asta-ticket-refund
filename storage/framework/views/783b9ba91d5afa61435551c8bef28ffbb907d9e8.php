...
<?php $component->withAttributes(['id' => $getId(),'label' => $getLabel(),'label-sr-only' => $isLabelHidden(),'helper-text' => $getHelperText(),'hint' => $getHint(),'hint-icon' => $getHintIcon(),'required' => $isRequired(),'state-path' => $getStatePath()]); ?>
    <div
        ...
        wire:ignore
        <?php echo e($attributes->merge($getExtraAttributes())->class('filament-forms-markdown-editor-component')); ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.bold')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.bold')).'']); ?>
                                        <md-bold>
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('italic')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.italic')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.italic')).'']); ?>
                                        <md-italic>
                                            <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                'h-4',
                                                'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('strike')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.strike')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.strike')).'']); ?>
                                        <md-strikethrough>
                                            <svg class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                                'h-4',
                                                'dark:fill-current' => config('forms.dark_mode'),
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('link')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.link')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.link')).'']); ?>
...
<?php endif; ?>
                        ...
                        <?php if($hasToolbarButton(['codeBlock', 'bulletList', 'orderedList'])): ?>
                            <div class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($hasToolbarButton('codeBlock')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.code_block')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.code_block')).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('bulletList')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.bullet_list')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.bullet_list')).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if($hasToolbarButton('orderedList')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.ordered_list')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.ordered_list')).'']); ?>
...
<?php endif; ?>
                        ...
                        <?php if($hasToolbarButton(['attachFiles'])): ?>
                            <div class="flex items-stretch space-x-1 rtl:space-x-reverse">
                                <?php if($hasToolbarButton('attachFiles')): ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'forms::components.markdown-editor.toolbar-button','data' => ['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.attach_files')).'']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms::markdown-editor.toolbar-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(__('forms::components.markdown_editor.toolbar_buttons.attach_files')).'']); ?>
...
<?php endif; ?>
                    ...
                    <?php if($hasToolbarButton(['edit', 'preview']) && $isEnabled()): ?>
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            <?php if($hasToolbarButton('edit')): ?>
                                <button
                                    type="button"
                                    x-on:click.prevent="tab = 'edit'"
                                    x-bind:class="{ 'text-gray-400 <?php if(config('forms.dark_mode')): ?> dark:text-gray-400 <?php endif; ?>': tab !== 'edit' }"
                            ...
                            <?php if($hasToolbarButton('preview')): ?>
                                <button
                                    ...
                                    x-bind:class="{ 'text-gray-400 <?php if(config('forms.dark_mode')): ?> dark:text-gray-400 <?php endif; ?>': tab !== 'preview' }"
...
<?php endif; ?>
<?php /**PATH /Users/mat/Projects/AStA/asta-ticket-refund/vendor/filament/forms/resources/views/components/markdown-editor.blade.php ENDPATH**/ ?>