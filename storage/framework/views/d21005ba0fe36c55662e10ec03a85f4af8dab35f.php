...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('l1991737353-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1991737353-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1991737353-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1991737353-0');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('l1991737353-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
	<div class="!mt-8">
...
} elseif ($_instance->childHasBeenRendered('l1991737353-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1991737353-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1991737353-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1991737353-1');
} else {
    $response = \Livewire\Livewire::mount(ShuvroRoy\FilamentSpatieLaravelBackup\Components\BackupDestinationListRecords::class);
    $html = $response->html();
    $_instance->logRenderedChild('l1991737353-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
	</div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /Users/mat/Projects/AStA/asta-ticket-refund/vendor/shuvroroy/filament-spatie-laravel-backup/src/../resources/views/pages/backups.blade.php ENDPATH**/ ?>