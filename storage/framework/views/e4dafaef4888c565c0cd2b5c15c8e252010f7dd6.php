...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="rounded-md border-2 border-slate-400 py-1 bg-slate-50 <?php echo e($contentClasses); ?>">
            <?php echo e($content); ?>

        </div>
    </div>
</div>
<?php /**PATH /Users/mat/Projects/AStA/asta-ticket-refund/resources/views/components/dropdown.blade.php ENDPATH**/ ?>