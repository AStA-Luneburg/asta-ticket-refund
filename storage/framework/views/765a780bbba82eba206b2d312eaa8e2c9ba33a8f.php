...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'tables::components.button','data' => ['form' => $getForm(),'type' => $canSubmitForm() ? 'submit' : 'button','wire:click' => $wireClickAction,'xOn:click' => $canCancelAction() ? 'isOpen = false' : null,'color' => $getColor(),'outlined' => $isOutlined(),'icon' => $getIcon(),'iconPosition' => $getIconPosition(),'size' => $getSize(),'attributes' => $getExtraAttributeBag(),'class' => 'filament-tables-modal-button-action']] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /Users/mat/Projects/AStA/asta-ticket-refund/vendor/filament/tables/src/../resources/views/actions/modal/actions/button-action.blade.php ENDPATH**/ ?>